document.addEventListener('DOMContentLoaded', function() {
    ...
    const interactiveElements = document.querySelectorAll('.cta-button-wrapper, .cta-image-link, .cta-button-image');
    ...
    style.textContent = `
        ...
        body:not(.keyboard-user) .cta-button-wrapper:focus,
        body:not(.keyboard-user) .cta-image-link:focus,
        body:not(.keyboard-user) .cta-button-image:focus {
            outline: none !important;
            box-shadow: none !important;
            border: none !important;
        }
